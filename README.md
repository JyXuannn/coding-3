...
After downloading the dataset for the first time I chose the frontal part (about 500 photos, which I trained 10,000 times to ensure the final result).https://github.com/JyXuannn/coding-3/blob/main/generated_images_epoch_10000.png
